...
| --- | --- | --- | --- |
[![local](https://github.com/user-attachments/assets/2b9a6ec2-e6cd-4415-9553-6c7bfb5e7722)](https://github.com/camenduru/TostUI#-tostui---song-generation-large) | | | TostUI - Song Generation (large - Min 24GB VRAM)
...
2.  **Update the container (optional)**
    ...
    ``` bash
    docker stop tostui-songgeneration-large; docker rm tostui-songgeneration-large; docker pull camenduru/tostui-songgeneration:large
    ```

3.  **Run the container**

    ``` bash
    docker run --gpus all -p 3000:3000 --name tostui-songgeneration-large camenduru/tostui-songgeneration:large
    ```
